...
#else  //8266 8267 8269
	#ifndef		CFG_ADR_MAC
	#define		CFG_ADR_MAC						0x76000//MAC地址
	#endif

	#ifndef		CUST_CAP_INFO_ADDR
	#define		CUST_CAP_INFO_ADDR				0x77000//频偏校准信息
	#endif

	#ifndef		CUST_TP_INFO_ADDR
	#define		CUST_TP_INFO_ADDR				0x77040//TP校准值
	#endif

	#ifndef		CUST_32KPAD_CAP_INFO_ADDR
	#define		CUST_32KPAD_CAP_INFO_ADDR		0x77080//32K RC的电容校准值
	#endif
#endif
